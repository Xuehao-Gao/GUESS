...
class MldDenoiser(nn.Module):
    ...
    def forward(self,
        ...
        if self.arch == "trans_enc":
            ...
            if coarser_motion_embedding is not None:
                coarser_motion_embedding = coarser_motion_embedding.permute(1,0,2)
                xseq = torch.cat((xseq, coarser_motion_embedding), axis=0)
